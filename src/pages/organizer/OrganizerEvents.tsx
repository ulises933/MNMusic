    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Gestiona tus eventos publicados</p>
        </div>
        <Button className="gradient-primary text-white border-0" onClick={() => navigate('/o/events/new')}>
      ...
      {myEvents.length === 0 ? (
        <div className="text-center py-20 text-muted-foreground">
          ...
          <Button className="gradient-primary text-white border-0 mt-2" onClick={() => navigate('/o/events/new')}>Crear tu primer evento</Button>
        </div>
      ) : (
                ...
                <TableRow key={event.id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-1">
                      ...
                      <Button variant="ghost" size="icon" onClick={() => navigate(`/o/events/${event.id}/edit`)}><Edit className="w-4 h-4" /></Button>
                      {event.status !== 'closed' && (
